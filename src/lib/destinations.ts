...
const destinations: Destination[] = [
  {
    ...
    slideshowImages: [
      { url: 'https://placehold.co/1280x720.png', hint: 'Sarayu river boat' },
      { url: 'https://placehold.co/1280x720.png', hint: 'Ram Mandir Ayodhya night' },
      { url: 'https://placehold.co/1280x720.png', hint: 'Hanuman Garhi temple' },
    ],
  ...
  },
  {
    ...
    slideshowImages: [
      { url: 'https://placehold.co/1280x720.png', hint: 'Ganges aarti ceremony' },
      { url: 'https://placehold.co/1280x720.png', hint: 'boats on Ganges river Varanasi' },
      { url: 'https://placehold.co/1280x720.png', hint: 'Kashi Vishwanath temple' }
    ],
  ...
  },
  {
    ...
    slideshowImages: [
        { url: 'https://placehold.co/1280x720.png', hint: 'Krishna Janmabhoomi Mathura' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Holi festival Vrindavan' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Prem Mandir Vrindavan' }
    ],
  ...
  },
   {
    ...
    slideshowImages: [
        { url: 'https://placehold.co/1280x720.png', hint: 'Dwarkadhish temple sunset' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Gomti Ghat Dwarka' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Bet Dwarka island ferry' }
    ],
  ...
  },
  {
    ...
    slideshowImages: [
        { url: 'https://placehold.co/1280x720.png', hint: 'Ramanathaswamy Temple gopuram' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Pamban Bridge train' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Dhanushkodi beach ruins' }
    ],
  ...
  },
  {
    ...
    slideshowImages: [
        { url: 'https://placehold.co/1280x720.png', hint: 'Har Ki Pauri evening aarti' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Lakshman Jhula bridge Rishikesh' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Yoga Rishikesh ganges' }
    ],
  ...
  },
  {
    ...
    slideshowImages: [
        { url: 'https://placehold.co/1280x720.png', hint: 'Rath Yatra Puri festival' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Puri beach sunset' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Konark Sun Temple wheel' }
    ],
  ...
  },
  {
    ...
    slideshowImages: [
        { url: 'https://placehold.co/1280x720.png', hint: 'Tirumala hills temple' },
        { url: 'https://placehold.co/1280x720.png', hint: 'devotees queue Tirupati' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Sri Venkateswara Swamy Vaari Temple' }
    ],
  ...
  },
  {
    ...
    slideshowImages: [
        { url: 'https://placehold.co/1280x720.png', hint: 'Golden Temple reflection night' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Langar Golden Temple community kitchen' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Wagah Border ceremony' }
    ],
  ...
  },
  {
    ...
    slideshowImages: [
        { url: 'https://placehold.co/1280x720.png', hint: 'Kedarnath temple snow' },
        { url: 'https://placehold.co/1280x720.png', hint: 'Himalayan mountain peaks' },
        { url: 'https://placehold.co/1280x720.png', hint: 'pilgrims trekking Kedarnath' }
    ],
